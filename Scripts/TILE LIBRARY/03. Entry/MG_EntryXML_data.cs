...
public class MG_EntryXML_data : MG_TileXML_data
{
    [SerializeField]
    private List<Sprite> XMLSpriteIsoHList = new List<Sprite>();//Спрайт Isometric H будущего свойства 
    [SerializeField]
    private List<Sprite> XMLSpriteIsoVList = new List<Sprite>();//Спрайт Isometric V будущего свойства
    [SerializeField]
    private List<Sprite> XMLSprite2DHList = new List<Sprite>();//Спрайт 2D Top Down H будущего свойства
    [SerializeField]
    private List<Sprite> XMLSprite2DVList = new List<Sprite>();//Спрайт 2D Top Down V будущего свойства
    [SerializeField]
    private List<EntryType> XMLEntryTypeList = new List<EntryType>();//Тип пола будущего свойства
    ...
    public void AddEntryType(EntryType _entryType)
    {
        XMLEntryTypeList.Add(_entryType);
    }
